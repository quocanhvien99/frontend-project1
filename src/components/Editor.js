...
const Editor = ({ keyword, setIsCreateNew, isEdit, setIsEdit }) => {
    ...
    return (
        <div className="Editor">
            ...
            <input type="text" id="number" placeholder="Nhập con số tương ứng" value={number} onChange={updateNumber}></input>
            <CKEditor
            ...
            />
            <button onClick={handleClick}>{isEdit.active?'Cập nhật':'Tạo'}</button>
